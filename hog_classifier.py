...
img = skimage.io.imread("./LoveDA/Train/Rural/images_png/" + str(test_img_number) + ".png")
mask = skimage.io.imread("./LoveDA/Train/Rural/masks_png/" + str(test_img_number) + ".png")
