...
# ax1.axis('off')
# ax1.imshow(im_i[:, :, 0], cmap=plt.cm.gray)
# ax1.set_title('Red')
#
# ax2.axis('off')
# ax2.imshow(im_i[:, :, 1], cmap=plt.cm.gray)
# ax2.set_title('Green')
#
# ax3.axis('off')
# ax3.imshow(im_i[:, :, 2], cmap=plt.cm.gray)
# ax3.set_title('Blue')
#
# plt.show()
# #--------------------------------------------------------------
...
# fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(8, 4), sharex=True, sharey=True)
# ax1.axis('off')
# ax1.imshow(im_lbp_rgb[:, :, 0], cmap=plt.cm.gray)
# ax1.set_title('Red')
#
# ax2.axis('off')
# ax2.imshow(im_lbp_rgb[:, :, 1], cmap=plt.cm.gray)
# ax2.set_title('Green')
#
# ax3.axis('off')
# ax3.imshow(im_lbp_rgb[:, :, 2], cmap=plt.cm.gray)
# ax3.set_title('Blue')
#
# plt.show()
# #--------------------------------------------------------------
...
# im_hybrid = np.hstack((im_i_g, im_m))
# im_hybrid = np.hstack((im_hybrid, y_pred_img))
